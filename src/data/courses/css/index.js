  ...
  chapters: [
    {
      ...
      topics: [
        ...
        },
        {
          id: 'css-selectors',
          title: 'CSS Selectors',
          summary: 'Type, class, ID, and universal selectors.',
          content: [
            { type: 'paragraph', text: 'CSS selectors are used to "select" HTML elements to style, based on their tag, class, id, attributes, and more.' },
